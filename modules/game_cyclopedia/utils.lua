...
-- This table stores house information by house ID
-- The actual house data (owners, bids, etc.) comes from the server
-- This structure provides the static info (name, size, rent, etc.)
-- Load HOUSE table from generated file (985 real houses from server XML)
dofile(g_resources.getRealDir('modules') .. '/game_cyclopedia/utils_houses_generated')

...
function onGameConnectionError(message, code)
    ...
    -- Agendar auto-reconnect mesmo quando errorBox está aberto
    -- Isso permite que o reconnect funcione mesmo com a tela de erro visível
...
function CharacterList.showAgain()
    if characterList and characterList:hasChildren() then
        -- Agendar reconnect antes de show() para garantir execução
        scheduleAutoReconnect()
        CharacterList.show()
    end
end

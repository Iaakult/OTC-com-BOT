...
-- CORRECAO: Exportar QuickLoot para o namespace do modulo
function quickLootController:onInit()
    print("[QuickLoot] Iniciando modulo game_quickloot...")
    
    -- Garantir que QuickLoot seja acessivel via modules.game_quickloot
    _G.QuickLoot = QuickLoot

    QuickLoot.Define()
    
    print("[QuickLoot] Modulo inicializado com sucesso!")

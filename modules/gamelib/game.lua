...
function g_game.getUseOldProtocol()
    return g_settings.getBoolean('use-old-protocol') or false
end
...
function g_game.getSupportedClients()
    return { 740, 741, 750, 755, 760, 770, 772, 780, 781, 782, 790, 792, 800, 810, 811, 820, 821, 822, 830, 831, 840,
        ...
        1286, 1287, 1291, 1300, 1310, 1311, 1314, 1316, 1320, 1321, 1322, 1332, 1334, 1336, 1337, 1340, 1400, 1405, 1410, 1412, 1511}
end

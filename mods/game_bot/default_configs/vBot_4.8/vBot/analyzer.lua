...
onTextMessage(function(mode, text)
    ...
    add(t, os.date('%H:%M') .. ' Loot of ' .. name .. ": ", "#FFFFFF", true)
    add(messageT, "Loot of " .. name .. ": ", "#FFFFFF", true)
    ...
    if re ~= 0 then
        for i=1,#re do
            ...
            -- Primeiro: extrair quantidade se presente no formato "quantidade, nome"
            local quantityMatch = itemName:match("^(%d+),%s*(.+)")

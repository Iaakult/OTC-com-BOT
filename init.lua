...
-- updater
Services = {
    status = "https://187.77.45.66/statusotc.php",
    websites = "https://187.77.45.66/?news",
    createAccount = "https://187.77.45.66/?account/create",
}

Servers_init = {
    ["http://104.234.186.179/login.php"] = {
        ["port"] = 80,
        ["protocol"] = 1511,
        ["httpLogin"] = true
    },
...
g_app.setName("otbaiakv2");
g_app.setCompactName("otbaiakv2");
g_app.setOrganizationName("OTC");
...
local function loadModules()
    ...
    g_modules.ensureModuleLoaded('game_exaltationforge')
    g_modules.ensureModuleLoaded('game_performance_monitor')
